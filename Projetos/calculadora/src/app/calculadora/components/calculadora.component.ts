...
export class CalculadoraComponent implements OnInit {
  ...
  /**
 * Returna o valor concatenado. Tratando o separador decimal.
 *
 ...
 */
  ...
  /**
   * Caso já possua uma operacao selecionada, executa a operação
   * anterior, definindo assim a nova operação.
   * 
  ...
  definirOperacao(operacao: string): void {
    ...
    // caso operação definida é numero 2 selecionado, efetua o cálculo da operação
